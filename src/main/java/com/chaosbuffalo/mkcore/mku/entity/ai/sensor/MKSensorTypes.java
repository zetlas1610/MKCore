...
public class MKSensorTypes {
    ...
    public static SensorType<DestinationSensor> DESTINATION_SENSOR;
    ...
    public static void registerModuleTypes(RegistryEvent.Register<SensorType<?>> evt){
        ...
        DESTINATION_SENSOR = new SensorType<>(DestinationSensor::new);
        DESTINATION_SENSOR.setRegistryName(MKCore.MOD_ID, "sensor.destionation");

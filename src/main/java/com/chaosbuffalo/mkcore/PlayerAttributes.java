...
public class PlayerAttributes {
    public static final RangedAttribute MAX_MANA = (RangedAttribute) new RangedAttribute(null, "mkultra.max_mana", 0, 0, 1024)
            .setDescription("Max Mana")
            .setShouldWatch(true);

    public static final RangedAttribute MANA_REGEN = (RangedAttribute) new RangedAttribute(null, "mkultra.mana_regen", 0, 0, 1024)
            .setDescription("Mana Regen")
            .setShouldWatch(true);

    public static final RangedAttribute HEALTH_REGEN = (RangedAttribute) new RangedAttribute(null, "mkultra.health_regen", 0, 0, 1024)
            .setDescription("Health Regen")
            .setShouldWatch(true);

    public static final RangedAttribute MAGIC_ATTACK_DAMAGE = (RangedAttribute) new RangedAttribute(null, "mkultra.magic_attack_damage", 0, 0, 2048)
            .setDescription("Magic Attack Damage")
            .setShouldWatch(true);

    public static final RangedAttribute MAGIC_ARMOR = (RangedAttribute) new RangedAttribute(null, "mkultra.magic_armor", 0, 0, 64)
    ...
    public static final RangedAttribute MELEE_CRITICAL_DAMAGE = (RangedAttribute) new RangedAttribute(null, "mkultra.melee_crit_damage", 0.0, 0.0, 10.0)
